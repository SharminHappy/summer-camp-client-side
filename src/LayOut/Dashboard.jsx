...
import { FaAddressBook, FaCaretLeft, FaFootballBall, FaHome, FaSignOutAlt, FaUser, FaWallet } from "react-icons/fa";
                ...
                <ul className="menu p-4   my-5 text-white uppercase gap-3 justify-center">
                    {
                        isAdmin ?
                            ...
                            : isInstructor ?
                                <>
                                    <li className=" w-64 ml-4 "><NavLink to='/dashboard/instructor'><FaHome></FaHome>Instructor Home</NavLink></li>
                                    <li className="w-64 ml-4 "><NavLink to='/dashboard/addclass'><MdSportsCricket></MdSportsCricket>Add a Class</NavLink></li>
                                    <li className="w-64 ml-4"><NavLink to='/dashboard/myclass'><FaUser></FaUser>My Class</NavLink></li>
                                    <div className="divider h-1 w-60 ml-2 rounded-lg  bg-yellow-500"></div>
                                    <li className=" w-64 ml-4 "><NavLink to='/'><FaHome></FaHome>Home</NavLink></li>
                                    <li className=" w-64 ml-4" onClick={handleLogOut} ><a ><FaSignOutAlt></FaSignOutAlt>Logout</a></li>
